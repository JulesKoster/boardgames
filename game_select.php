...
<head>
    ...
    ?>
    <div class="row justify-content-center" id="pawnDiv">
    <div class="col-xl-3" style="z-index: 100; background: white;"></div>
        <div class="col-xl-6 pawnDiv">
        <div id="pawnDivDivider">&nbsp;</div>
        <img src="img/icons/pawn-100100.svg" width="80px" height="80px" id="pawnSelecter">
        </div>
    <div class="col-xl-3" style="z-index: 100; background: white;"></div>
        </div>
    </div>
    <div class="row justify-content-center align-content-center backGround">
        <div class="col-xl-6">
            ...
            <form action="game_select_script.php" method="post">
                    ...
                    <div class="card mt-5" id='2' style='display:none'>
                        <div class="card-body">
                    ...
                    <div class="card mt-5" id='3' style='display:none'>
                        <div class="card-body">
                    ...
                    <div class="card mt-5" id='5' style='display:none'>
                        <div class="card-body">
                    ...
                    <div class="card mt-5" id='6' style='display:none'>
                        <div class="card-body">
