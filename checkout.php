    ...
    <div class='container borderform my-5'>
        <div class='container-fluid'>
            <div class='col-xl-12 text-center mt-2 mb-5'>
                ...
                <a href="login_form.php" id="formbutton" type="submit" name="changeInfo" class="btn btn-secondary">Login</a>
            </div>
        </div>
    </div>
    ...
    <div class='container-fluid'>
        ...
        <div class='col-xl-3'></div>
            <div class='col-xl-3'>
                ...
                <input type="text" class="form-control" name="first_name" id="first_name" value="<?php echo $row['user_first_name'] ?>" style="text-transform: capitalize;" autofocus required>
                <label for="middle_name">Tussenvoegsel: </label>
                <input type="text" class="form-control" name="middle_name" id="middle_name" value="<?php echo $row['user_middle_name'] ?>" style="text-transform: capitalize;">
                <label for="last_name">Achternaam: </label>
                <input type="text" class="form-control" name="last_name" id="last_name" value="<?php echo $row['user_last_name'] ?>" style="text-transform: capitalize;" required>
            ...
            <div class='col-xl-3'>
                ...
                <input type="text" class="form-control" name="place" id="place" value="<?php echo $row['user_place'] ?>" style="text-transform: capitalize;" required>
                <label for="streetname">Straatnaam: </label>
                <input type="text" class="form-control" name="streetname" id="streetname" value="<?php echo $row['user_streetname'] ?>"  style="text-transform: capitalize;" required>
